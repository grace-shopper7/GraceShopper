...
class UserDetails extends Component {
  ...
  handleSubmit(event) {
    ...
    this.props.addAddress(this.props.user.id, { street: this.state.street, city: this.state.city, zipcode: this.state.zipcode, state: this.state.state, country: this.state.country});
  ...
  render() {
    ...
    return (
      <AddUserDetailsForm state={this.state} handleSubmit={this.handleSubmit} handleChange={this.handleChange}/>
    );
  }
}
